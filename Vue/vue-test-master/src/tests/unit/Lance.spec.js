...
describe('Um Lance sem valor mínimo', () => {
  test('Nãa aceita lance com valor menor do que zero', () => {
...
describe('um lance com valor minimo', () => {
  ...
  test('não são aceitos valores menores do que o minimo informado', async () => {
    const wrapper = mount(Lance, {
      propsData: {
        lanceMinimo: 300
      }
    ...
    input.setValue(100)
    wrapper.trigger('submit')
    await wrapper.vm.$nextTick() // metodo que aguardo o DOM ser atualizado
